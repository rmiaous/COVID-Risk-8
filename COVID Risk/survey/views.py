...
# Function to read the db and get latest row of data entered
# Work on that data to get the risk level
def read_db():
...
def index(request):
    if request.method == "GET":
        form = SurveyFormInfo
        context = {'form': form}
        return render(request, 'survey/hi.html', context)
    else:
